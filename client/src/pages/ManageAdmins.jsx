...
const ManageAdmins = () => {
  ...
  return (
    <div className="min-h-screen bg-surface-100">
      ...
      <div className="bg-white shadow">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex justify-between items-center">
            <div>
              <h1 className="text-2xl font-bold text-surface-900">Manage Institution Admins</h1>
              <p className="text-sm text-surface-600 mt-1">View and manage all institution administrators</p>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {loading ? (
          <div className="text-center py-12">
            ...
            <p className="mt-4 text-surface-600">Loading admins...</p>
          </div>
        ) : (
            ...
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {admins.length === 0 ? (
                  ...
                  admins.map((admin) => (
                    <tr key={admin.id} className="hover:bg-surface-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm text-surface-900">{admin.username}</div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm text-surface-900">{admin.email}</div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                        {admin.institutionId ? (
                          <div className="text-sm text-surface-900">
                            <div className="font-medium">{admin.institutionId.name}</div>
                            <div className="text-surface-500 text-xs">{admin.institutionId.domain}</div>
                          </div>
                        ) : (
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        <button
                          ...
                          className="text-brand-600 hover:text-blue-900 mr-4"
                        >
                          Edit
                        </button>
                        <button
      ...
      {/* Edit Modal */}
      {showEditModal && (
        <div className="fixed inset-0 bg-surface-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
          <div className="relative top-20 mx-auto p-5 border w-full max-w-2xl shadow-lg rounded-md bg-white">
            <div className="flex justify-between items-center mb-4">
              <h3 className="text-xl font-semibold text-surface-900">Edit Admin</h3>
              <button
            ...
            <form onSubmit={handleUpdate} className="space-y-4">
              ...
              <div className="flex justify-end gap-3 mt-6">
                <button
                  type="button"
                  onClick={() => setShowEditModal(false)}
                  className="px-4 py-2 bg-surface-200 text-surface-800 rounded-md hover:bg-surface-300"
                >
                  Cancel
                </button>
                <button
